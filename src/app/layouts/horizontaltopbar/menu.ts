...
export const MENU: MenuItem[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            {
                id: 115,
                label: 'MENUITEMS.TITLE.TEXT',
                icon: 'bx-file',
                subItems: [
                    {
                        id: 116,
                        label: 'MENUITEMS.TITLE.LIST.STARTER',
                        link: '/pages/title-list',
                        parentId: 115
                    },
                    {
                        id: 117,
                        label: 'MENUITEMS.TITLE.LIST.MAINTENANCE',
                        link: '/pages/maintenance',
                        parentId: 115
                    },
                    {
                        id: 118,
                        label: 'MENUITEMS.TITLE.LIST.COMINGSOON',
                        link: '/pages/coming-soon',
                        parentId: 115
                    },
                    {
                        id: 119,
                        label: 'MENUITEMS.TITLE.LIST.TIMELINE',
                        link: '/pages/timeline',
                        parentId: 115
                    },
                    {
                        id: 120,
                        label: 'MENUITEMS.TITLE.LIST.FAQS',
                        link: '/pages/add-title',
                        parentId: 115
                    },
                    {
                        id: 121,
                        label: 'MENUITEMS.TITLE.LIST.PRICING',
                        link: '/pages/pricing',
                        parentId: 115
                    },
                    {
                        id: 122,
                        label: 'MENUITEMS.TITLE.LIST.ERROR404',
                        link: '/pages/404',
                        parentId: 115
                    },
                    {
                        id: 123,
                        label: 'MENUITEMS.TITLE.LIST.ERROR500',
                        link: '/pages/500',
                        parentId: 115
                    },
                ]
